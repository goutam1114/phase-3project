...
import com.simplilearn.webservice.exceptions.ProductAlredyExistsException;
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ExceptionResponse> alreadyExistException(ProductAlredyExistsException exception) {
		response = new ExceptionResponse(exception.getMessage(), new Date(), 
				HttpStatus.BAD_REQUEST.name(), exception.getClass().getSimpleName());
		return new ResponseEntity<ExceptionResponse>(response,HttpStatus.BAD_REQUEST);
	}
